...
func New(
	gatewayBase, proxyBase, apiKey, nodeID, wallet, region, version string,
	gpuInfo gpu.Info,
	getStats StatsFunc,
	...
	payload, err := BuildRegistration(nodeID, apiKey, wallet, region, version, gpuInfo, nil)
	if err != nil {
...
func (r *Router) SetModel(model string) {
	...
	payload, err := BuildRegistration(r.nodeID, r.apiKey, r.wallet, r.region, r.version, r.gpuInfo, []string{model})
	if err != nil {
